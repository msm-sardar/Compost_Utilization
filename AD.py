...
class AD:
    ...
    def calc(self):
        ...
        self.AD_input.AD_operation['choice_BU']['amount'] = self.CommonData.Organic_analysis['choice_BU']['amount']
        self.AD_input.AD_operation['peatOff']['amount'] = self.CommonData.Organic_analysis['peatOff']['amount']
        self.AD_input.AD_operation['fertOff']['amount'] = self.CommonData.Organic_analysis['fertOff']['amount']
        
        self.AD_input.Land_app['perN2Oevap']['amount'] = self.CommonData.Organic_analysis['perN2Oevap']['amount']
        self.AD_input.Land_app['perNH3evap']['amount'] = self.CommonData.Organic_analysis['perNH3evap']['amount']
        self.AD_input.Land_app['perNasNH3fc']['amount'] = self.CommonData.Organic_analysis['perNasNH3fc']['amount']
