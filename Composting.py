...
class Comp:
    ...
    def calc(self):
        ...
        self.Comp_input.Fertilizer_offset['choice_BU']['amount'] = self.CommonData.Organic_analysis['choice_BU']['amount']
        self.Comp_input.Fertilizer_offset['peatOff']['amount'] = self.CommonData.Organic_analysis['peatOff']['amount']
        self.Comp_input.Fertilizer_offset['fertOff']['amount'] = self.CommonData.Organic_analysis['fertOff']['amount']
        
        self.Comp_input.Land_app['perN2Oevap']['amount'] = self.CommonData.Organic_analysis['perN2Oevap']['amount']
        self.Comp_input.Land_app['perNH3evap']['amount'] = self.CommonData.Organic_analysis['perNH3evap']['amount']
        self.Comp_input.Land_app['perNasNH3fc']['amount'] = self.CommonData.Organic_analysis['perNasNH3fc']['amount']
