...
### Output Technospphere Database
            ...
            if self.Compost_input.operation['choice_BU']['amount'] == 0:
                ...
                Technosphere[y][('Technosphere', 'market_for_excavation_skid_steer_loader')] = self.LCI['market_for_excavation_skid_steer_loader'][y]
            else:
                Technosphere[y][('Technosphere', 'compost_to_LF')] = 0
                Technosphere[y][('Technosphere', 'Electricity_production')] = 0
                Technosphere[y][('Technosphere', 'market_for_excavation_skid_steer_loader')] = 0
...
### Output Biosphere Database
            ...
            if self.Compost_input.operation['choice_BU']['amount'] == 1 and self.Compost_input.operation['peatOff']['amount'] == 1:
                ...
                Biosphere[y][('biosphere3', '349b29d1-3e58-4c66-98b9-9d1a076efd2e')]= 0
